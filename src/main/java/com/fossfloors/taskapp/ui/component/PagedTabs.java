...
public class PagedTabs extends Composite<Tabs> {
   ...
   * 
   * @param componentContainer The component container (e.g. VerticalLayout) in which the tab
   *                           contents should be displayed. This container should be added to a
   *                           layout outside the PagedTabs component.
   */
